...
def reset_apple(active_apple):
      ...
      if (length_of_list != 0):
            ...
            active_apple.goto(rand.randint(-(screen_width)/2,(screen_width)/2), rand.randint(-(screen_hight)/2, (screen_height)/2))
...
def draw_letter(letter, active_apple):
    ...
    active_apple.write(letter, "A", font=("Arial", 74, "bold"))
